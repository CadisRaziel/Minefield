...
//{[styles.flagpole, props.bigger ? styles.flagpoleBigger : null]} = casso a propriedade "bigger" esteja presente,
//ele vai adicioanr o styles.flagpoleBigger se não ele adiciona null e não vai ter nenhum efeito colateral(ele nao aplica nada)